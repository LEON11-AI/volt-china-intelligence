...
const Hero: React.FC = () => {
  ...
  return (
    ...
    <section id="brief" className="relative min-h-[100svh] overflow-hidden scroll-mt-24 pb-20 pt-32 md:scroll-mt-28 lg:pb-32 lg:pt-48">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[90rem] px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-5xl grid-cols-2 gap-4 border-t border-slate-800/50 pt-8 md:grid-cols-4">
