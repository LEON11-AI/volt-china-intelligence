...
const BYD_ADAS_Strategy: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 font-sans">
      <Navbar />
      <main>
        <PageHero compact eyebrow="EDITORIAL ANALYSIS" title="BYD ADAS Revolution" description="Editorial analysis of BYD ADAS architecture, strategy, and software context.">
