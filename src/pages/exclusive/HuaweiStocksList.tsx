              ...
              return (
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="inline-flex items-center gap-2 rounded-full bg-slate-800/60 border border-slate-700/60 p-1 self-start md:self-auto">
                    ...
                    <Link to="/exclusive/vip-supply-9961" className={`px-4 py-2 rounded-full transition-colors ${isStocks ? 'bg-slate-900 text-white' : 'text-slate-300 hover:text-white'}`}>Supplier Signals</Link>
                  </div>
